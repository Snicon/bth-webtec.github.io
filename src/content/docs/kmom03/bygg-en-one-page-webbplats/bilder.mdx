...
<div class="wrapper">
-  <h1>Här skall vi nu fylla på med innehåll!</h1>
...
Studera CSS-koden så kan du se att vi tänker jobba med rader som bas-layout och inuti en rad finns det 1, 2 eller 3 kolumner som kan ha innehåll. Varje rad kan ha en bakgrundsfärg så kan vi skifta mellan ljusa och mörka bakgrundsfärger när vi bygger upp sidan.
