---
title: "Jobba med Git" 
description: Vi tittar på ett antal av de grundläggande kommandona i Git.
author: mos
revision:
    "2026-06-11": "(B, mos) Bygg om för ny struktur med kursrepo."
...
{/* TODO
* Uppdatera author i package.json
*/}
...
Här får du se ett antal kommandon som är grundläggande i git och de hjälper dig när du skall jobba igenom kursen.

Du kan provköra kommandona mot ditt eget git repo, men notera att du kan få olika resultat om du jämför med artikelns bilder.
...
Texten säger att filen `.editorconfig` ännu inte är en del av ditt repo. Men det kan alltså se annorlunda ut för ditt eget repo.



## git add 

Låt oss, som ett exempel, lägga till filen som saknas med kommandot `git add`.

Vill du själv prova att lägga till en ny fil till ditt repo så kan du skapa en godtycklig fil i terminalen eller via vscode.
...
Nu räcker det alltså om du i fortsättningen skriver `git lg` för att se den formaterade varianten av git commit historik.
