---
title: "Artikel: Formulär element och JavaScript"
sidebar:
    order: 0020
---
...
Utan css ser det inte så roligt ut. Jag lägger följande i stylen:
...
Inmatningsfältet ser lite annorlunda ut. Håller man muspekaren över fältet ser man små pilar:
...
Det finns en hel del input element med olika betydelse och funktionalitet. Ge dig gärna ut och testa lite olika och kika på vilka attribut de tillhandahåller.