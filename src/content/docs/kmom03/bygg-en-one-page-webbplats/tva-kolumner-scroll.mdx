...
revision:
    ...
    "2026-08-12": "(A, mos) Rättade inkonsekvens: HTML-exemplet bytte color1/color3 mellan raden och kolumnerna jämfört med wrap-artikeln, trots att bara wrap/scroll skulle skilja."
sidebar:
    order: 0080
---
...
+<section class="row cols2 color3 rounded scroll">
