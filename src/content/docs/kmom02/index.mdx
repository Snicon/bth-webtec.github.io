...
Tanken är att vi har en enda grund för webbplatsen och med hjälp av CSS och lite JavaScript så får webbplatsen ändra utseende beroende av hur stor skärmen är på den enhet som visar webbplatsen.
...
1. [Introduktion till CSS](./introduktion-till-css) där vi går igenom grunderna i CSS och utgår från standarden och kikar på struktur, konstruktioner och hur det fungerar.

1. [Responsiv webbdesign](./responsiv-webbdesign) visar tankarna bakom konceptet och vissa grundstenar för att komma igång med responsiva webbplatser.
...
1. En bra guide för att förstå de olika delarna av hur flexbox fungerar är guiden [CSS Flexbox Layout Guide](https://css-tricks.com/snippets/css/a-guide-to-flexbox/), titta gärna kort i den och använd den som uppslagsverk för att se vilka möjligheter som finns.
...
1. Jobba igenom övningen "[Bygg en responsiv webbplats](./bygg-en-responsiv-webbplats)".

1. Gå igenom artikeln om [de vanligaste konstruktionerna del 1](./js-common-structures-1) i JavaScript.
...
1. Utför laborationen "[Lab 2: JavaScript med kontrollstrukturer (statements)](./lab_02/)".

1. Gör uppgiften "[Bygg en responsiv webbplats](./responsiv/)".



## Resultat & Redovisning

Läs [instruktionen om hur du skall redovisa](/studieguide/resultat-och-redovisning).
