...
description: "Prova så att du kan placera en tvåkolumnig layout så den wrappar om man lägger fler än två kolumner."
author: mos
revision:
...
Ibland vill jag ha mer flexibilitet i en rad än att bara placera 1, 2 eller 3 kolumner. Säg att jag vill placera 4 enheter i en tvåkolumnig layout, men jag vill att det hamnar på två rader, om det är fler kolumner än tänkt så skall de wrappas. En sådan flexibilitet vill jag att min layout skall kunna ha.
