...
Om du inte får någon utskrift från `npm run lint` så är allt okey. Om lintern upptäcker något fel så försöker du gå in och rättar det. Lita på att lintern har rätt. Kan du inte rätta det så ber du om hjälp.
