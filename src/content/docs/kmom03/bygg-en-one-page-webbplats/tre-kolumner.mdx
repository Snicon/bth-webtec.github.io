...
Nytt för denna varianten är att jag lade till klassen `.rounded` på raden så att jag kan styla att alla kolumner får rundade hörn med `border-radius`.

Jag kunde valt att placera klassen på varje kolumn, men här valde jag att lägga den enbart på row-elementet.
