      ...
      <article class="article">
        ...
        <footer class="byline">
          ...
          <figure class="figure left">
            <img src="https://mikaelroos.se/img/mos-tjaro.webp" alt="Bild på mig" width="100">
...
.article {
  ...
  display: flow-root;          /* Establishes a new block formatting context so the box always contains floated children, like the image further down */
}
```
...
Lägg märke till att `.article` fick `display: flow-root;` när vi stylade den tidigare. Det gör att `.article` alltid omsluter flytande innehåll som denna bild, oavsett hur mycket text som finns kvar under bilden. Utan den egenskapen kan bilden sticka ut nedanför artikelns ram om du inte har en footer/byline som "clearar" flytet efteråt (så som i exemplet nedan).
 ...
 */
.article .byline {
  clear: both;                  /* Clears the floated figure above so the byline starts below it */
