...
/* Matches the footer's background so any extra space below it on tall
   viewports looks like the footer instead of a white gap. */
body {
...
.footer-column ul li a:hover {
  color: #5cb85c;             /* Lighter green: passes WCAG AA (4.5:1) text contrast on the dark column background */
