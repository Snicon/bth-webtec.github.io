...
Du har installerat en egen terminal enligt guiden [Terminal och pakethanterare](/labbmiljo/terminal/).
...
3.  Packa sedan upp zip-filen med följande kommando:
    ...
    Om du inte har kommandot `unzip` installerat kommer det dyka upp en uppmaning att installera det. Du kan installera det med `sudo apt install unzip`.
